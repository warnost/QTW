...
#setwd("C:/Users/b007224/Documents/masters_in_data_science/quantifying_the_world/QTW/Case Study 2/Data")

els = readLines("C:/Users/b007224/Documents/masters_in_data_science/quantifying_the_world/QTW/Case Study 2/Data/men_2012.txt")

# search for spaces in the row of equals to identify columns
findColLocs = function(spacerRow) {

  # the g means this function searches for multiple matches
  spaceLocs = gregexpr(" ", spacerRow)[[1]]
  rowLength = nchar(spacerRow)

  # add an entry for the first column
  if (substring(spacerRow, rowLength, rowLength) != " ")
    return( c(0, spaceLocs, rowLength + 1))
  else return(c(0, spaceLocs))
}

# function to split the data into columns, based on spaces from the row of =
# also only includes the columns we specify
selectCols = 
function(colNames, headerRow, searchLocs) 
{
 ...
 ######## still need to drop that last line with blanks all the way across ########

extractVariables = 
  # list of columns we want to keep, only need to put enough letters to uniquely identify the columns
  function(file, varNames =c("name", "home", "ag", "gun","net", "time"))
    {
      ...
      # grab the row before the row of =, this is the header. AND change the text to lowercase for consistency to other files
      headerRow = tolower(file[ eqIndex - 1 ])
      #for the body, keep only rows after the row of =
      body = file[ -(1 : eqIndex) ]
           
      # use the function to find the spaces in the row of =, these are the beginning/ending positions for the columns
      searchLocs = findColLocs(spacerRow)
      # identify the beinning and ending positions for the selected columns
      locCols = selectCols(varNames, headerRow, searchLocs)
    
      # get the data for these selected columns, output is a matrix
...
##### 2009 is in XML format?
mfilenames = paste("C:/Users/b007224/Documents/masters_in_data_science/quantifying_the_world/QTW/Case Study 2/Data/men_", 1999:2008, ".txt", sep = "")
menFiles = lapply(mfilenames, readLines)
names(menFiles) = 1999:2008
