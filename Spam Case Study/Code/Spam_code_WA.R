...
pdf("../Plots/SP_Boxplot.pdf", width = 6, height = 6)
...
pdf("../Plots/LinePlotTypeI+IIErrors.pdf", width = 8, height = 6)
...
pdf("../Plots/ScatterPlotNumLinesNumChars.pdf", width = 6, height = 4.5)
...
pdf("../Plots/SPAM_boxplotsPercentCaps.pdf", width = 5, height = 5)
...
pdf("../Plots/SPAM_scatterplotPercentCapsTotChars.pdf", width = 8, height = 6)
...
pdf("../Plots/SPAM_mosaicPlots.pdf", width = 8, height = 4)
...
library(rpart.plot)
pdf("../Plots/SPAM_rpartTree.pdf", width = 7, height = 7)
...
pdf("../Plots/SPAM_rpartTypeIandII.pdf", width = 8, height = 7)
library(RColorBrewer)
cols = brewer.pal(9, "Set1")[c(3, 4, 5)]
