...
The steps outline above are used both on the offline textfile (training) and the online textfile (test). 
...
offline_pivot = select(offline_pivot,-c(posX, posY, time, orientation, rawTime, nas))
...
online_pivot = select(online_pivot,-c(posX, posY,time,orientation, rawTime))
