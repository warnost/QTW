...
We use Q-Q plots to examine whether the age distribution of male runners changed from 1999 to 2012. The animated Q-Q plots below show, year by year, the age distribution of runners versus the theoretical quantiles, assuming a normal distribution of ages. The animation keeps the 1999 data on the plot for reference, and shows that, as years go by, the Q-Q plot bows downward as the ages of runners decrease. Although this downward trend in age appears to occur gradually, the year 2004 appears to be the first large jump downward in age distribution. However, as we'll see in the boxplots and density plots in the following sections, the decrease in median age began occurring as early as 2001.
