...
The median age of Runners in the Cherry Blossom race decreased between 1999 and 2012. The results from each of our figures show the median age shifting from 40 in 1999 to 35 in 2012. The change starts out gradual but changes more rapidly from 2007 to 2009. There seems to be some stabilization in the last couple of years, but we would need to look at data for more recent years to confirm.  
